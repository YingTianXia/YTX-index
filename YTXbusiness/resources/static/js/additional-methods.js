...
$.validator.addMethod("licRegNumTest", function(value, element) {
...
$.validator.addMethod("legalCertTest", function(value, element) {
...
$.validator.addMethod("orgCodeCertNumTest", function(value, element) {
	return this.optional(element) || /^[a-zA-Z0-9]{8}-[a-zA-Z0-9]$/.test(value);
}, "请输入正确的组织机构代码");

$.validator.addMethod("imgTest", function(value, element) {
