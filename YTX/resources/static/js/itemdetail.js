;(function () {
    myReady(function () {
        ...
        var $J_descDetail = $("#J_descDetail").val();
        $("#detail_images_con_id").html($J_descDetail);
        //window.onload = function skuDetail() {
        //    alert(1);
        //    var itemId = $('#itemId').val();
        //    alert(itemId);
        //    $.ajax({
        //        type: "post",
        //        url: "/item/skuDetailList?itemId="+itemId,
        //        async: true,
        //        dataType:'json',
        //        contentType: "application/json; charset=utf-8",
        //        data: {"itemId": itemId},
        //        success: function (data) {
        //            console.info(data.skuColorList);
        //            var ss = JSON.parse(data.skuColorList);
        //            console.log(ss);
        //            if (data.success == "true") {
        //                //$("#detail_images_con_id").html(data.itemDesc);
        //
        //            } else {
        //                $("#detail_images_con_id").html("空");
        //
        //            }
        //
        //        }
...
//	addListener(fixClose, 'click', fixSkuHide);
        ...
        if (document.getElementById('skuColorKey').value != '') {
